...
static void lcd_status_screen()
{
    ...
    {
        lcdDrawUpdate = 2;    //
        lcd_implementation_init();  //　　　　上面 + 這行 = 刷新畫面
...
//new end
void tigger_5_second()
{
  enquecommand_P("M441");
  enquecommand_P("G4 P5000");
  enquecommand_P("M440");
}
...
static void lcd_prepare_menu()
{
    ...
    MENU_ITEM(gcode, MSG_TIGGER_ON, PSTR("M441"));
    MENU_ITEM(gcode, MSG_TIGGER_OFF, PSTR("M440"));
    MENU_ITEM(function, MSG_TIGGER_5_SECOND, tigger_5_second);
//    MENU_ITEM(function, MSG_AUTO_HOME, new_home);
    //MENU_ITEM(gcode, MSG_SET_ORIGIN, PSTR("G92 X0 Y0 Z0"));
